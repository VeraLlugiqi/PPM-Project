...
//            sqlite3_bind_text(insertStatement, 2, category, -1, nil)
//            sqlite3_bind_text(insertStatement, 3, description, -1, nil)
//            sqlite3_bind_text(insertStatement, 4, isWatched, -1, nil)
//
//            // Execute the SQL statement
//            if sqlite3_step(insertStatement) == SQLITE_DONE {
//                print("Successfully inserted row.")
